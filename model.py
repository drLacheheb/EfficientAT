...
class MN(nn.Module):
    ...
    def _forward_impl(self, x: Tensor, return_fmaps: bool = False) -> Union[
        Tuple[Tensor, Tensor], Tuple[Tensor, List[Tensor]]]:
        fmaps = []
...
def _mobilenet_v3(
    ...
    if pretrained_name in pretrained_models:
        ...
        state_dict = load_state_dict_from_url(_model_url, model_dir=model_dir, map_location="cpu")
